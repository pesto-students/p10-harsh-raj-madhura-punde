// Problem 10.2 : Validate a Binary TreeGiven the root of a binary tree, determine 
// if it is a valid binary search tree (BST).
// A valid BST is defined as follows:The left subtree of a node contains only 
// nodes with keys less than the node's key. Theright subtree of a node contains 
// only nodes with keys greater than the node's key. Boththe left and right 
